...
DATADIR=${MAINDIR}/Data/${subj}/functional/x_ModKMID_3mm_2sec
IMAGEDIR=${MAINDIR}/Analysis/Images/${subj}x

mkdir -p ${IMAGEDIR}

cp ${MAINDIR}/Analysis/Images/${subj}/${subj}_anat_brain.nii.gz ${IMAGEDIR}
#set up log file
...
if [ ! -e kidmid_raw.nii ]; then #if doesn't exist
...
DATA=${IMAGEDIR}/${subj}_reoriented_func.nii.gz 
#OUTPUT=${MAINOUTPUT}
