...
maindir = '/Users/sarabergman/Documents/ELS/KIDMID/Analysis/L1/PPI/RightNAcc.Model5.BothPPI';
roidir = '/Users/sarabergman/Documents/ELS/KIDMID/Analysis/ROI/PPI/RightNAcc.Model5';
...
%     '073','074','075','076','077','079','081','083','085','087','088','090','093','095'}; %n = 66
...
for s = 1:length(sublist)
    ...
    PEfile = fullfile(maindir,[sub '.feat'],'featquery_PPI_Rinsula.01.29_PE','report.txt');
    A = importdata(PEfile);
...
cd(fullfile(roidir))
dlmwrite(['interaction_Rinsula_NAcc_antgain_PEs' date '.csv'],C,'delimiter','\t','newline','unix', 'precision', 7);
cd(cwd)
