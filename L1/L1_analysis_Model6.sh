...
##	--added temporal derivative to each EV


#for SUBJ in 025 026 028 029 030 031 033 034 035 036 037 038 039 040 041 042 045 046 047 048 049 050 054 055 056 057 058 059 060 061 062 064 065 067 068 069 070 072 074 075 076 077 079 081 083 085 087 088 089 093 095; do
for SUBJ in 073; do
#SUBJ=$1
SMOOTH=5
GO=1
...
if [ $(hostname) = sbergman.stanford.edu ];
then 
	TEMPLATE=/Users/sarabergman/Documents/ELS/KIDMID/scripts/FSF/L1/model6.fsf
else
	TEMPLATE=/Users/sarabergman/Documents/STANFORD/FYP/KIDMID/scripts/FSF/L1/model6.fsf
fi	
