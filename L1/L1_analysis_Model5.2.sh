...
##	--no missed.txt regressor

#012 #016 #029 #086 #089
#for SUBJ in 001 002 003 004 005 006 009 010 012 013 014 016 017 020 021 022 023 024 025 026 028 029 030 031 033 034 035 036 037 038 040 041 042 045 046 047 048 049 050 054 055 056 058 059 060 061 062 064 065 067 068 069 070 072 073 074 075 076 077 079 081 083 085 087 088 090 093 095 097 098 099 100; do
for SUBJ in 098; do
#SUBJ=$1
SMOOTH=5
GO=1
...
MAINOUTPUT=${MAINDIR}/L1/Model5.2
mkdir -p ${MAINOUTPUT}
#fi
...
if [ $(hostname) = sbergman.stanford.edu ];
then 
	TEMPLATE=/Users/sarabergman/Documents/ELS/KIDMID/scripts/FSF/L1/model5.2.fsf
else
	TEMPLATE=/Users/sarabergman/Documents/STANFORD/FYP/KIDMID/scripts/FSF/L1/model5.2.fsf
fi	
