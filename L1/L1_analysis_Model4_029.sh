...
#for SUBJ in 010 011 012 013 014 015 016 017 018 019 020 021 022 023 024 025 026 028 029 030 031 032 034 035 036; do 
#for SUBJ in 010; do
for SUBJ in 029; do 
SMOOTH=5
GO=1
...
CONFOUNDEVSFILE=${PRESTATSDIR}/motion_and_outlier_confounds.txt
...
TEMPLATE=/Users/sarabergman/Documents/STANFORD/FYP/KIDMID/scripts/FSF/L1/model3_029.fsf
#dos2unix $TEMPLATE
