...
MAINOUTPUT=${MAINDIR}/L1/PPI/RightInsula.antloss
mkdir -p ${MAINOUTPUT}
#fi
...
EVFILES=${MAINDIR}/EV/${SUBJ}/PPI.antloss

# OR
#EVFILES=${MAINDIR}/EV/no.missed/${SUBJ}

ev1=${EVFILES}/${SUBJ}_ant_loss_V_nonloss.txt
ev2=${EVFILES}/${SUBJ}_ant_loss_and_nonloss.txt
ev3=${EVFILES}/${SUBJ}_ant_gain.txt
ev4=${EVFILES}/${SUBJ}_ant_nongain.txt
...
if [ $(hostname) = sbergman.stanford.edu ];
then 
	TEMPLATE=/Users/sarabergman/Documents/ELS/KIDMID/scripts/FSF/PPI/Model5_antloss.fsf
else
