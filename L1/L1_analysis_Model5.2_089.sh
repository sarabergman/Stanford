...
if [ $(hostname) = sbergman.stanford.edu ];
then 
	TEMPLATE=/Users/sarabergman/Documents/ELS/KIDMID/scripts/FSF/L1/model5.2_89.fsf
else
	TEMPLATE=/Users/sarabergman/Documents/STANFORD/FYP/KIDMID/scripts/FSF/L1/model5.2_89.fsf
fi	
