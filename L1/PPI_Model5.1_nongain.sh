...
for SUBJ in 089; do
# 001 002 004 006 009 010 012 013 014 016 017 022 023 024 025 026 028 029 030 032 033 034 036 037 038 039 040 041 042 045 046 047 048 049 050 054 055 056 058 060 061 062 064 065 067 068 069 070 072 073 074 075 076 077 079 081 083 085 086 087 088 089 090 093 095 097 099 100 
...
MAINOUTPUT=${MAINDIR}/L1/PPI/RightNAcc.Model5.1.Nat_nongain
mkdir -p ${MAINOUTPUT}
#fi
...
EVFILES=${MAINDIR}/EV/${SUBJ}/PPI.antnongain

# OR
#EVFILES=${MAINDIR}/EV/no.missed/${SUBJ}

ev1=${EVFILES}/${SUBJ}_ant_nongain_V_gain.txt
...
TEMPLATE=/Users/sarabergman/Documents/ELS/KIDMID/scripts/FSF/PPI/Model5.1_antnongainPPI_089.fsf
